...
Il vérifie la version de Python, la presence de PyYAML, l'integrite du manifeste, des 7 agents, des 15 règles et des 10 portes, et il exécute le validateur sur l'exemple de référence. Il n'installé rien.
